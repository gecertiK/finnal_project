...
from .models import Book, Order, OrderItem, ShippingAddress, Customer
from .tasks import order_to_store, check_order_status, confirm_order_email
...
def process_order(request):
	...
	if order.shipping is True:
		if request.user.is_authenticated:
			...
			order_to_store.delay(customer_email, transaction_id)
